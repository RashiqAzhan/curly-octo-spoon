...
<table class="form-table hbupro-post-sett-tbl">
	<tbody>
			...
			<td colspan="2" class="hbupro-no-padding">
				...
				<table class="form-table hbupro-bgcolor" <?php echo $banner_bgcolor_style;?>>
					...
					<tr class="hbupro-feature">
						<th>
							<label><?php _e('Select Background Color Type ', 'hero-banner-ultimate'); ?><span class="hbupro-tag"><?php _e('PRO','hero-banner-ultimate');?></span>
							</label>
						</th>
						<td>
							<select name="<?php echo $prefix;?>color_type" class="hbupro-select-box" disabled="">
								<option ><?php _e('Plain Color', 'hero-banner-ultimate'); ?></option>
							</select><br/>
							<span class="description"><?php _e('Select background color type.', 'hero-banner-ultimate'); ?></span><?php echo sprintf( __( ' Upgrade to <a href="%s" target="_blank">Premium Version</a> to get this option.', 'hero-banner-ultimate'), HBU_PLUGIN_LINK); ?>
						</td>
					</tr>
					...
					<tr class="hbupro-feature">	
						...
						<th scope="row">
							<label><?php _e('Gradient Color Position ', 'hero-banner-ultimate'); ?><span class="hbupro-tag"><?php _e('PRO','hero-banner-ultimate');?></label>
						</th>
						<td>
							<select name="<?php echo $prefix;?>banner_gradient_position" class="hbupro-select-box" disabled="">
								<option ><?php _e('Left to Right', 'hero-banner-ultimate'); ?></option>
							</select><br />
							<span class="description"><?php _e('Gradient Color Position. This option works in background color option Gradient Color.', 'hero-banner-ultimate'); ?></span><?php echo sprintf( __( ' Upgrade to <a href="%s" target="_blank">Premium Version</a> to get this option.', 'hero-banner-ultimate'), HBU_PLUGIN_LINK); ?>
						</td>
					</tr>
				</table>
				...
				<table class="form-table hbupro-video" <?php echo $banner_video_style;?>>
					...
					<tr class="hbupro-feature">	
						...
						<th>
							<label><?php _e('Upload Poster ', 'hero-banner-ultimate'); ?><span class="hbupro-tag"><?php _e('PRO','hero-banner-ultimate');?></label>
						</th>
						<td class="row-meta">
							<input type="text" class="regular-text banner-default-img banner-img-upload-input" name="<?php echo $prefix.'banner_poster_url';?>" disabled="" />
							<input type="button" name="banner_default_img" class="button-secondary" value="<?php _e( 'Upload Poster', 'hero-banner-ultimate'); ?>" disabled="" />
							<input type="button" class="button button-secondary" name="popu_default_poster_clear" value="<?php _e( 'Clear', 'hero-banner-ultimate'); ?>" disabled="" /><br />
							<span class="description"><?php _e('Upload Video Poster image.', 'hero-banner-ultimate'); ?></span><?php echo sprintf( __( ' Upgrade to <a href="%s" target="_blank">Premium Version</a> to get this option.', 'hero-banner-ultimate'), HBU_PLUGIN_LINK); ?>
						</td>
					</tr>
		...
		<tr class="hbupro-feature">
			<th>
				<label><?php _e('Uppercase Title ', 'hero-banner-ultimate'); ?><span class="hbupro-tag"><?php _e('PRO','hero-banner-ultimate');?></label>
			</th>
			<td>
				<input type="checkbox" name="<?php echo $prefix;?>banner_title_upper" value="Title Uppercase" disabled="" /><br />
				<span class="description"><?php _e('Check to Display Title Text on UPPERCASE', 'hero-banner-ultimate'); ?></span><?php echo sprintf( __( ' Upgrade to <a href="%s" target="_blank">Premium Version</a> to get this option.', 'hero-banner-ultimate'), HBU_PLUGIN_LINK); ?>
			</td>
		</tr>
		<!-- SubTitle Size -->	
		<tr valign="top">
		...
		<tr class="hbupro-feature">
			<th>
				<label><?php _e('Uppercase Sub Title ', 'hero-banner-ultimate'); ?><span class="hbupro-tag"><?php _e('PRO','hero-banner-ultimate');?></label>
			</th>
			<td>
				<input type="checkbox" name="<?php echo $prefix;?>banner_title_upper" value="Title Uppercase" disabled="" /><br />
				<span class="description"><?php _e('Check to Display Subtitle Text on UPPERCASE', 'hero-banner-ultimate'); ?></span><?php echo sprintf( __( ' Upgrade to <a href="%s" target="_blank">Premium Version</a> to get this option.', 'hero-banner-ultimate'), HBU_PLUGIN_LINK); ?>
			</td>
		</tr>
		...
		<tr valign="top" style="border-bottom:1px solid #ddd;">
			<th scope="row" colspan="2"><h3 style="padding-bottom:0px;margin-bottom:0px;"><?php _e('Mobile Settings', 'hero-banner-ultimate'); ?></h3></th>
		</tr>

		<tr class="hbupro-feature">
			<th>
				<label><?php _e('Title Font Size ', 'hero-banner-ultimate'); ?><span class="hbupro-tag"><?php _e('PRO','hero-banner-ultimate');?></label>
			</th>
			<td>
				<input type="number" name="<?php echo $prefix;?>banner_mobile_title_fontsize" class="regular-text" placeholder="<?php _e('30', 'hero-banner-ultimate'); ?>" disabled="" /> px <br/>
				<span class="description"><?php _e('Enter title font size in PX', 'hero-banner-ultimate'); ?></span><?php echo sprintf( __( ' Upgrade to <a href="%s" target="_blank">Premium Version</a> to get this option.', 'hero-banner-ultimate'), HBU_PLUGIN_LINK); ?>
			</td>
		</tr>
		...
		<tr class="hbupro-feature">
			<th>
				<label><?php _e('Sub Title Font Size ', 'hero-banner-ultimate'); ?><span class="hbupro-tag"><?php _e('PRO','hero-banner-ultimate');?></label>
			</th>
			<td>
				<input type="number" name="<?php echo $prefix;?>banner_mobile_subtitle_fontsize" class="regular-text" placeholder="<?php _e('18', 'hero-banner-ultimate'); ?>" disabled="" /> px <br/>
				<span class="description"><?php _e('Enter sub title font size in PX', 'hero-banner-ultimate'); ?></span><?php echo sprintf( __( ' Upgrade to <a href="%s" target="_blank">Premium Version</a> to get this option.', 'hero-banner-ultimate'), HBU_PLUGIN_LINK); ?>
			</td>
		</tr>

		<tr class="hbupro-feature">
			<th scope="row">
				<label for="banner-bg-size"><?php _e('Background Image Size', 'hero-banner-ultimate'); ?><span class="hbupro-tag"><?php _e('PRO','hero-banner-ultimate');?></label>
			</th>
			<td class="row-meta">
				<select name="<?php echo $prefix;?>banner_mobile_bg_size" class="hbupro-select-box" disabled="">
					<option value=""><?php _e('Cover', 'hero-banner-ultimate'); ?></option>
				</select>
				<br/>
				<span class="description"><?php _e('Select bacground image size for mobile.', 'hero-banner-ultimate'); ?></span><?php echo sprintf( __( ' Upgrade to <a href="%s" target="_blank">Premium Version</a> to get this option.', 'hero-banner-ultimate'), HBU_PLUGIN_LINK); ?>
			</td>			
		</tr>
